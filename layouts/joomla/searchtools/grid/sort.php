...
?>
<a href="#" onclick="return false;" class="js-order-col hasTooltip" data-order="<?php echo $data->order; ?>" data-name="<?php echo JText::_($data->title); ?>" title="<?php echo $metatitle; ?>">
